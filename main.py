...
def ask_ai(question: str) -> str:
    ...
    system_prompt = (
        ...
        "20. КРИТИЧЕСКИ ВАЖНО: если данных по запросу не найдено или вопрос "
        "не связан с финансами компании — отвечай текстом по существу. "
        "НИКОГДА не возвращай остатки по счетам если их не спрашивали. "
        "Если категория не найдена — так и скажи: что именно не найдено и почему.\n"
    )
